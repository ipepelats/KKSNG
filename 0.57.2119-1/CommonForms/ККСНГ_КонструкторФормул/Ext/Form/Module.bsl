...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ККСНГ_ОбщегоНазначения.ПроверитьФормулу(Формула, КомпоновщикНастроек.Настройки.ДоступныеПоляОтбора);
...
Процедура КомпоновщикНастроекНастройкиВыборДоступныеПоляВыбораВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(Операнд) Тогда
		ККСНГ_ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
...
Функция ПроверитьФормулу(Формула)
	...
	Результат = ККСНГ_ОбщегоНазначения.ПроверитьФормулу(Формула, КомпоновщикНастроек.Настройки.ДоступныеПоляОтбора, ТекстОшибки);
	
	Если ЗначениеЗаполнено(ТекстОшибки) Тогда
		ККСНГ_ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстОшибки,, "Формула");
	КонецЕсли;
...
Процедура УстановитьУсловноеОформление()
	...
	Список.ЗагрузитьЗначения(ККСНГ_ОбщегоНазначения.ВыгрузитьКолонку(
